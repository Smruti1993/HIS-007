...
import { Plus, Search, Printer, DollarSign, FileText, Trash2, X, History, Ban, AlertTriangle, ChevronDown, CreditCard, Package, Pill, Stethoscope, Save, ArrowLeft, MoreHorizontal, CheckSquare, Square, Loader2 } from 'lucide-react';
